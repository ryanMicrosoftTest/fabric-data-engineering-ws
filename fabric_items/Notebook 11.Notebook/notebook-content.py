...
!pip install abfss://a8cbda3d-903e-4154-97d9-9a91c95abb42@onelake.dfs.fabric.microsoft.com/98142750-133b-48db-a038-ffec3f8427df/Files/presidio/models/en_core_web_lg-3.8.0-py3-none-any.whl
...
%pip install --no-cache-dir --force-reinstall numpy==1.26.4 pandas==2.1.4 pyarrow==15.0.2 numexpr==2.8.7 spacy==3.7.4 thinc==8.2.4 presidio-analyzer presidio-anonymizer
...
csv_path = "Files/lakehouse/default/Files/presidio/data/sample_users_500.csv"
...
provider = NlpEngineProvider(nlp_configuration=json.dumps(configuration))
...
df = spark.read.csv.load('Files/presidio/data/sample_users_500.csv')
...
df = spark.read.format("csv").option("header","true").load("Files/presidio/data/sample_users_500.csv")
# df now is a Spark DataFrame containing CSV data from "Files/presidio/data/sample_users_500.csv".
display(df)
