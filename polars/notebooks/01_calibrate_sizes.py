# Fabric benchmark notebook: 01_calibrate_sizes
# Kernel: jupyter
...
# %% [markdown]
# # 01 - Calibrate compressed sizes
# Measures the on-disk (ZSTD Parquet) size of each generated size folder and suggests the scale factor needed to hit the 1 / 10 / 50 GB **compressed** targets. Default lakehouse = `lh_bench_source`.
