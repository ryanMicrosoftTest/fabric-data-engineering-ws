...
# Reads TPC-DS Parquet from the **default lakehouse (`lh_bench_source`)**, adds ingest metadata, and writes Delta to `lh_bench_bronze` under schema `polars_<size>`. Narrow, scan-heavy, low-shuffle work — Polars' sweet spot.
# 
