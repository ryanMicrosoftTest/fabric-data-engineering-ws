...
# Reads `silver.sales_conformed` from the **default lakehouse (`lh_bench_silver`)** and builds curated marts (group-bys + window functions), written to `lh_bench_gold` with the pinned runtime's native streaming `sink_delta`.
# 
